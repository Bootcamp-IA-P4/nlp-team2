...
const GuideTab = () => {
  ...
  return (
    <>
      {/* 🎯 METADATA PARA GUÍA */}
      <AppMetadata 
        pageTitle="Guía de Toxicidad"
        pageDescription="Aprende sobre los diferentes tipos de contenido tóxico: crítico, alto, medio. Guía completa para identificar toxicidad en comentarios."
      />
